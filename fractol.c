...
/*   Updated: 2025/06/05 19:15:44 by johyorti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv)
{
    ...
    fractol.mlx = mlx_init(WIDTH, HEIGHT, TITLE, false);
    if (!fractol.mlx)
    ...
    mlx_close_hook(fractol.mlx, mlx_close_hook, &fractol);
    render_fractal(fractol.mlx);
}
